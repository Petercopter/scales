...
ActiveRecord::Schema.define(version: 2019_06_04_170702) do
  ...
  create_table "piano_keys_pitches", force: :cascade do |t|
    t.integer "piano_key_id", null: false
  ...
  add_foreign_key "piano_keys_pitches", "piano_keys"
  add_foreign_key "piano_keys_pitches", "pitches"
end
